...
function getHeader(request, key) {
  var _a3, _b, _c;
  const value = ((_b = (_a3 = request.headers) == null ? void 0 : _a3.get) == null ? void 0 : _b.call(_a3, key)) ?? ((_c = request.headers) == null ? void 0 : _c[key]);
...
var Script = (0, import_react27.forwardRef)(
  (props, ref) => {
    ...
    return (0, import_jsx_runtime22.jsx)("script", { suppressHydrationWarning: true, ...props, nonce, ref });
  }
);
